...
namespace EGamp.Engine.Asio
{
    ...
    /// </summary>
    internal class MyASIODriverExt
    {
        private MyASIODriver driver;
        private ASIOCallbacks callbacks;
        private MyAsioDriverCapability capability;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MyASIODriverExt"/> class based on an already
        /// instantiated ASIODriver instance.
        /// </summary>
        /// <param name="driver">A ASIODriver already instantiated.</param>
        public MyASIODriverExt(MyASIODriver driver)
        {
            this.driver = driver;
        ...
        public MyAsioDriverCapability Capabilities
        {
        ...
        {
            capability = new MyAsioDriverCapability();
