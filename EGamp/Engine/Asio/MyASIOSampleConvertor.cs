...
namespace EGamp.Engine.Asio
{
    ...
    /// format.
    /// </summary>
    internal class MyASIOSampleConvertor
    {
        ...
        /// <returns></returns>
        public static SampleConvertor SelectSampleConvertor(WaveFormat waveFormat, MyAsioSampleType asioType)
        {
            ...
            switch (asioType)
            {
                case MyAsioSampleType.Int32LSB:
                    ...
                    break;
                case MyAsioSampleType.Int16LSB:
                    switch (waveFormat.BitsPerSample)
                    {
                        case 16:
                    ...
                    break;
                case MyAsioSampleType.Int24LSB:
                    switch (waveFormat.BitsPerSample)
                    {
                        case 16:
                    ...
                    break;
                case MyAsioSampleType.Float32LSB:
                    switch (waveFormat.BitsPerSample)
                    {
                        case 16:
                            throw new ArgumentException("Not a supported conversion");
                ...
                default:
                    throw new ArgumentException(
                        String.Format("ASIO Buffer Type {0} is not yet supported.",
                                      Enum.GetName(typeof(MyAsioSampleType), asioType)));
            }
            return convertor;
        }
