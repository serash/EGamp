...
namespace EGamp.Engine.Asio
{
    ...
    internal class MyASIODriver
    {
        ...
        public static MyASIODriver GetASIODriverByName(String name)
        {
        ...
        /// <returns>an ASIODriver instance</returns>
        public static MyASIODriver GetASIODriverByGuid(Guid guid)
        {
            MyASIODriver driver = new MyASIODriver();
