...
namespace EGamp.Engine.Asio
{
    ...
    public class MyAsioOut : IWavePlayer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MyAsioOut"/> class with the driver name.
        /// </summary>
        /// <param name="driverName">Name of the device.</param>
        public MyAsioOut(String driverName)
        {
        ...
        public MyAsioOut(int driverIndex)
        {
            this.syncContext = SynchronizationContext.Current; 
        ...
        /// <see cref="MyAsioOut"/> is reclaimed by garbage collection.
        /// </summary>
        ~MyAsioOut()
        {
            Dispose();
